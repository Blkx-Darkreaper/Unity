...
namespace Strikeforce
{
    public class SaveManager : Manager
    {
        ...
        private static void SaveCamera(JsonWriter writer)
        {
            ...
            Entity camera = GameObject.FindGameObjectWithTag(Tags.MAIN_CAMERA).GetComponent<Entity>();
            if (camera != null)
            {
        ...
        private static void SaveTerrain(JsonWriter writer)
        {
            ...
            Entity ground = GameObject.FindGameObjectWithTag(Tags.GROUND).GetComponent<Entity>();
            if (ground != null)
            {
        ...
        private static void SaveEnvironment(JsonWriter writer)
        {
            ...
            Entity sun = GameObject.FindGameObjectWithTag(Tags.SUN).GetComponent<Entity>();
            if (sun != null)
            {
